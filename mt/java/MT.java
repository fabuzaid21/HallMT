public class MT {
	/*
	 * Actual code underneath. Because the Submit script required one file, we concatenated everything 
	 * together, but it would not compile due to the multiple public class declarations and POS tagger
	 * integration. We could not find an alternative within the submit time. So, we commented
	 * all of our code out. Our full java Eclipse project is located at the DropBox link below.
	 * 
	 * DROPBOX LINK: http://dl.dropbox.com/u/15937740/HallMT.zip
	 */
}
